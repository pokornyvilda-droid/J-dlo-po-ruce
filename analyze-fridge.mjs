    ...
    const r = await fetch('https://api.openai.com/v1/responses', {
      ...
      body:JSON.stringify({
        ...
        input:[{role:'user',content:[
          {type:'input_text',text:'Jsi pomocník aplikace JÍDLO PO RUCE. Prohlédni fotografii lednice, spíže nebo nákupní tašky. Vrať pouze platný JSON ve tvaru {"ingredients":["..."],"uncertain":["..."]}. Uváděj jen potraviny, které jsou na fotografii rozumně rozpoznatelné. Čeština. Nehádej značky ani přesné množství.'},
